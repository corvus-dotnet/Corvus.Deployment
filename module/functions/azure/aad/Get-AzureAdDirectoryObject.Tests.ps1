    ...
    Context "Finding a group" {
        ...
        Context "Searching by ObjectId" {
            ...
            It "should return the group" {
                ...
                Should -Invoke _groupById -Times 1 -Scope Context
                Should -Invoke _spByAppId -Times 1 -Scope Context
                Should -Invoke _spByObjectId -Times 1 -Scope Context
                Should -Invoke _userById -Times 1 -Scope Context
                Should -Invoke _groupByName -Times 0 -Scope Context
                Should -Invoke _spByName -Times 0 -Scope Context
                Should -Invoke _userByName -Times 0 -Scope Context
            }
        }
        ...
        Context "Searching by DisplayName" {
            ...
            It "should return the group" {
                ...
                Should -Invoke _groupById -Times 0 -Scope Context
                Should -Invoke _spByAppId -Times 0 -Scope Context
                Should -Invoke _spByObjectId -Times 0 -Scope Context
                Should -Invoke _userById -Times 0 -Scope Context
                Should -Invoke _groupByName -Times 1 -Scope Context
                Should -Invoke _spByName -Times 1 -Scope Context
                Should -Invoke _userByName -Times 1 -Scope Context
            }
        }
    }
